...
export declare class FileApi extends runtime.BaseAPI {
     ...
     */
    copyFile(params: CopyFileOperationParams): Promise<CopyFileResponse>;
    /**
     ...
     */
    downloadFile(params: DownloadFileParams): Promise<runtime.BinaryResult>;
    /**
     * Gets the full details (e.g. metadata, tags, etc.) for a file.
     */
    getFileDetails(params: GetFileDetailsParams): Promise<FileDetails>;
    /**
     * Processes a file and returns the result.
     */
    processFile(params: ProcessFileParams): Promise<runtime.BinaryResult>;
    /**
     * Processes a file and saves the result.
     */
    processFileAndSave(params: ProcessFileAndSaveOperationParams): Promise<ProcessFileAndSaveResponse>;
}
/**
 * @export
 */
export declare type ProcessFileCachePermEnum = "auto" | "false" | "true";
